...
**迭代期望定律**（Law of Iterated Expectations, LIE），通常也被称为**全期望公式**（Adam's Law），是概率论中一个非常核心的定理。它描述了随机变量的条件期望与边缘期望之间的关系。
...
此外，还有一个非常有用的**塔式属性（Tower Property）**。如果 $\mathcal{G}_1 \subset \mathcal{G}_2$（即 $\mathcal{G}_1$ 包含的信息比 $\mathcal{G}_2$ 少），那么：
